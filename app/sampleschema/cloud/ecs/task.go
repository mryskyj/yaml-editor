...
type RunTask struct {
	...
	Count          int               `yaml:"count,omitempty" default:"1" desc:"number of tasks to run"`
	Overrides      map[string]string `yaml:"overrides,omitempty" desc:"container override values"`
}
