...
type AddAccount struct {
	...
	Kind     accountKind                   `yaml:"Kind,omitempty" default:"standard" enum:"standard,premium,temporary" desc:"account kind"`
	Tags     []string                      `yaml:"Tags,omitempty" desc:"account tags"`
	Metadata map[accountMetadataKey]string `yaml:"Metadata,omitempty" desc:"metadata values keyed by logical name"`
	Contacts []AddAccountContact           `yaml:"Contacts,omitempty" desc:"contact list"`
...
type AddAccountContact struct {
	...
	Email string `yaml:"Email,omitempty" desc:"contact email address"`
}
